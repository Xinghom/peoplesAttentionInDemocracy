    ...
    var words_usEng = list[0].columns.slice(1,10).map(function(id) {
        return {
            ...
            values: (id === "total" ? list[0].map(function(d) {
                return {laguage: "American English", year: d.year, number: d[id]/8, sum: +d.sum}; }) : list[0].map(function(d) {
                return {language: "American English",year: d.year, number: d[id], sum: +d.sum};})),
    ...
    var words_chi = list[1].columns.slice(1,10).map(function(id) {
        return {
          ...
          values: (id === "total" ? list[1].map(function(d) {
                return {language: "Chinese language", year: d.year, number: d[id]/8, sum: +d.sum}; }) : list[1].map(function(d) {
    ...
    var words_heb = list[2].columns.slice(1,10).map(function(id) {
        return {
          ...
          values: (id === "total" ? list[2].map(function(d) {
                return {language: "Hebrew language", year: d.year, number: d[id]/8, sum: +d.sum}; }) : list[2].map(function(d) {
              return {language: "Hebrew language", year: d.year, number:d[id], sum: +d.sum};
          })),
          visible: (id === "total" ? true : false)
        }
    });
    var words_rus = list[3].columns.slice(1,10).map(function(id) {
        return {
          ...
          values: (id === "total" ? list[3].map(function(d) {
                return {language: "Russian language", year: d.year, number: d[id]/8, sum: +d.sum}; }) : list[3].map(function(d) {
              return {language: "Russian language", year: d.year, number:d[id], sum: +d.sum};
          })),
          visible: (id === "total" ? true : false)
        }
    });
    var words_spa = list[4].columns.slice(1,10).map(function(id) {
        return {
          ...
          values: (id === "total" ? list[4].map(function(d) {
                return {language: "Spanish language", year: d.year, number: d[id]/8, sum: +d.sum}; }) : list[4].map(function(d) {
              return {language: "Spanish language", year: d.year, number:d[id], sum: +d.sum};
          })),
          visible: (id === "total" ? true : false)
        }
    });
...
//    console.log(array_maxNumsOfList);
    ...
    //define y axis
    y.domain([0, d3.max(array_maxNumsOfList)]);
    y_percent.domain([0, d3.max(array_maxPercentOfList)]);
